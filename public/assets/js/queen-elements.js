$(document).ready(function(){
	...
	/********************************************/
		...
		$('#edu_date_start').editable();
		$('#edu_date_end').editable();
		$('#pd_date_start').editable();
		...
		$('#degree').editable();
		$('#field_of_study').editable();
		$('#grade').editable();
		$('#activities_and_societies').editable();
		$('#edu_description').editable();
		$('#school').editable();
		$('#twitter').editable();
		$('#facebook').editable();
		$('#dribbble').editable();
